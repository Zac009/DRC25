...
def generate_mask_stream(mask_func, var):
...
@app.route('/mask1')
def stream_mask1():
    return Response(generate_mask_stream("pass", 1),
                    mimetype='multipart/x-mixed-replace; boundary=frame')

@app.route('/mask2')
def stream_mask2():
    return Response(generate_mask_stream("pass", 2),
                    mimetype='multipart/x-mixed-replace; boundary=frame')
...
if __name__ == '__main__':
    ...
    app.run(host='10.1.1.172', port=5001, threaded=True)
